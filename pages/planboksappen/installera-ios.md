...
Denna sida beskriver hur du installerar den statliga identitetsplånboksappen på en iPhone via **TestFlight**.

Du behöver först ha blivit inbjuden som testare och fått en inbjudningslänk skickad till dig.
Se [Få åtkomst till appen](prova-planboksappen.md#1-få-åtkomst-till-appen) om du inte har gjort det ännu.
...
Den kan inte installeras på enheter med äldre iOS-version.
...
2. Öppna e-postmeddelandet med din inbjudan och klicka på inbjudningslänken från din telefon.
   En sida öppnas nu i webbläsaren (testflight.apple.com).
...
4. TestFlight öppnas med din inbjudan.
   Klicka på **Godkänn** (Accept) och därefter på **Installera** för att hämta plånboksappen.
