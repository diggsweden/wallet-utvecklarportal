...
2.  **PID-utfärdare** – Tjänsten som utfärdar och signerar det grundläggande identitetsintyget (PID) – i testmiljön tillhandahålls denna av Digg (i framtida produktion är det Polismyndigheten).
