...
> **Obs:** Denna anslutningsguide avser **Diggs plånboksapp** som använder sig av **Testplattform för digital identitetsplånbok** för test och utveckling.
...
- **EUDIW-dokumentation:** [eudi-doc-architecture-and-reference-framework](https://eudi.dev/latest/)
